...
# [inline (always)]
pub fn bus_errors (& mut self) -> BUS_ERRORS_W { BUS_ERRORS_W { w : self } } } } } # [doc = "ETHPHY"]
...
# [inline (always)]
pub const fn ptr () -> * const ethphy :: RegisterBlock { 0xf000_1800 as * const _ } } impl Deref for ETHPHY { type Target = ethphy :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const hub75_palette :: RegisterBlock { 0xf000_2000 as * const _ } } impl Deref for HUB75_PALETTE { type Target = hub75_palette :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const hub75 :: RegisterBlock { 0xf000_2800 as * const _ } } impl Deref for HUB75 { type Target = hub75 :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0xff << 8)) | (((value as u32) & 0xff) << 8) ; self . w } } impl R { # [doc = "Bits 0:7 - x position in multiples of 32"]
# [inline (always)]
pub fn x (& self) -> X_R { X_R :: new ((self . bits & 0xff) as u8) } # [doc = "Bits 8:15 - y position in multiples of 32"]
# [inline (always)]
pub fn y (& self) -> Y_R { Y_R :: new (((self . bits >> 8) & 0xff) as u8) } } impl W { # [doc = "Bits 0:7 - x position in multiples of 32"]
# [inline (always)]
pub fn x (& mut self) -> X_W { X_W { w : self } } # [doc = "Bits 8:15 - y position in multiples of 32"]
# [inline (always)]
pub fn y (& mut self) -> Y_W { Y_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [panel0_1](panel0_1) module"]
...
pub fn x (& mut self) -> X_W { X_W { w : self } } # [doc = "Bits 8:15 - y position in multiples of 32"]
# [inline (always)]
pub fn y (& mut self) -> Y_W { Y_W { w : self } } } } } # [doc = "IDENTIFIER_MEM"]
...
# [inline (always)]
pub const fn ptr () -> * const identifier_mem :: RegisterBlock { 0xf000_3000 as * const _ } } impl Deref for IDENTIFIER_MEM { type Target = identifier_mem :: RegisterBlock ; # [inline (always)]
