...
pub rx_datapath_crc_errors : RX_DATAPATH_CRC_ERRORS , # [doc = "0x44 - Bits 32-47 of `ETHMAC_MAC_ADDRESS`. The value won't take effect until `ETHMAC_MAC_ADDRESS0` is written."]
pub mac_address1 : MAC_ADDRESS1 , # [doc = "0x48 - Bits 0-31 of `ETHMAC_MAC_ADDRESS`. Writing this register triggers an update of `ETHMAC_MAC_ADDRESS`."]
...
# [inline (always)]
pub fn rx_datapath_crc_errors (& mut self) -> RX_DATAPATH_CRC_ERRORS_W { RX_DATAPATH_CRC_ERRORS_W { w : self } } } } # [doc = "Bits 32-47 of `ETHMAC_MAC_ADDRESS`. The value won't take effect until `ETHMAC_MAC_ADDRESS0` is written.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mac_address1](mac_address1) module"]
